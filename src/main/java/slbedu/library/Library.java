...
public class Library {
	...
	public static void main(String[] args) {
		...
		registerUser("FourthUser", "Test1234", "fourth.user@somemail.com", new Date());
	...
	private static void borrowBook(String userName, String author, String title) {
		...
		if(userToBorrow == null) {
			System.out.println("User does not exist in database and cannot borrow books");
			return;
		}
	...
	private static void registerUser(String userName, String password, String email, Date dateOfBirth) { 
		boolean userExistng = userDAO.isUserExistng(userName);
		if(userExistng) { 
